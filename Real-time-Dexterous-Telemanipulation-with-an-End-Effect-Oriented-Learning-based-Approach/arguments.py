...
def get_args():
    ...
    parser.add_argument('--env-name', type=str, default='HandManipulateBlockRotateZ-v1', help='the environment name')
    ...
    parser.add_argument('--seed', type=int, default=198, help='random seed')
    ...
    parser.add_argument('--gamma', type=float, default=0.98, help='the discount factor') #0.98
